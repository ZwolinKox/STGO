...
<?php
    ...
    if(DatabaseManager::selectBySQL('SELECT isAdmin FROM users WHERE id='.$_SESSION['uid'])[0]['isAdmin'] == 0)
    {
...
<body style="background-color: rgb(95, 95, 95); color: white;">
    ...
    <!-- Bez tej linijki nie dzialal mi ajax, dziwne :/ -->
