...
<body style="background-color: rgb(95, 95, 95); color: white;">
    ...
    <div class="container"> <!-- ŚRODEK !-->
        <div class="row">
				...
				<div class="col-12 text-center display-4">Słyszlotek</div>
				...
				<div class="col-12 col-md-6" style="margin-top: 15px;">
                    ...
                    <?php
                        ...
                        {
                            echo '<h3 style="color: red;">Dzisiaj grałeś już w Słyszlotka</h3>';
                        ...
                        else
                        {
                            if(Get::exist('gra'))
                            {
                                if(Get::get('gra') == 'tak')
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            echo '<h3 style="color: red;">Nie tym razem...</h3>';
                                        }

                                        DatabaseManager::updateTable('users', ['boolLotek' => 'true'], ['id' => $_SESSION['uid']]);
                                        echo '<br> <div class="btn-dark btn-lg href" id="index.php">Wróć do domu</div>';
                            ...
                            {
                                echo '<div class="btn-dark btn-lg href" id="lotek.php?gra=tak">Graj (Koszt 15 Słysz Coinów)</div>';
