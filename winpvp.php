...
<?php
    ...
    if(!isset($_SESSION['logged']) || $_SESSION['logged'] == false)
        ...
        if(!isset($_SESSION['winpvp']) || $_SESSION['winpvp'] == false)
            header('Location: index.php');
        else
            unset($_SESSION['win']);
    ...
    <div class="container"> <!-- ŚRODEK !-->
        <div class="row">
				...
				<div class="col-12 col-md-6" style="margin-top: 15px;">
                    ...
                    <h3 style="margin-top: 50px;">Zdobyłeś <span style="color: gold"><?php echo 20;?></span> punktów ligowych!</h3>
                    ...
                    <br> <div class="btn-dark btn-lg href" id="szkola.php">Idź grzecznie do szkoły</div>
                    <br> <div class="btn-dark btn-lg href" id="sklodowska.php">Wróć walczyć</div>
