...
<body style="background-color: rgb(95, 95, 95); color: white;">
    ...
    <div class="container"> <!-- ŚRODEK !-->
        <div class="row">
				...
				<div class="col-12 text-center display-4">Zaproszenia do gangu</div>
                ...
                $wynik = DatabaseManager::selectbySQL("SELECT * FROM ganginv WHERE visible=1 AND playerId=".$_SESSION['uid']);
                    ...
                    echo '<br><table class="table table-striped table-dark">
                            ...
                            if(is_array($wynik))
                            {
                                ...
                                echo '
                                        <tr>
                                            <th scope="row">'.$wynik[$i]['guildName'].'</th>
                                            <th class="yes" id='.$wynik[$i]['guildName'].' class="textacc" style="color: green;">'.'Akceptuj'.'</th>
                                            <th class="no" id='.$wynik[$i]['guildName'].' class="textacc" style="color: red;">'.'Odrzuć'.'</th>
                                        </tr>';
                                }
                            }
                    ...
                    echo    '</tbody>
                            ...
                            <div class="btn-dark btn-lg href" id="gangs.php">Wróć do strony gangu</div>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        buttons = document.querySelectorAll('.no');
