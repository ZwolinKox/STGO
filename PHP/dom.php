    ...
    <div class="container"> <!-- ŚRODEK !-->
        <div class="row">
				...
				<div class="col-12 col-md-6" style="margin-top: 15px;">
                        ...
                        <div class="btn-dark btn-lg href" id="template.php">Wyjdz z domu</div><br>
                        <div class="btn-dark btn-lg href cztery" id="spanie.php">Idz spać</div><br>
                        <div class="btn-dark btn-lg href trzy" id="napraw-komputer.php">Napraw komputer</div>
                        <div class="btn-dark btn-lg href" id="memy.php">Wyslij mema na grupe</div>
                        <div class="btn-dark btn-lg href" id="brat.php">Wyzywanie brata</div>
                        <div class="btn-dark btn-lg href" id="poczta.php">Poczta</div>
                        <div class="btn-dark btn-lg href" id="ksiazka.php">Książka telefoniczna</div>
                        <div class="btn-dark btn-lg href" id="melanz.php">Zrób melanż w domu</div>
